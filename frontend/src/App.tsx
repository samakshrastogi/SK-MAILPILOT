...
export default function App() {
  ...
  if (authLoading && !authUser) {
    return <div className="grid min-h-screen place-items-center bg-slate-50 text-slate-900"><div className="flex items-center gap-3 rounded-2xl bg-white px-5 py-4 shadow-sm"><img src="/sk-logo.png" alt="" className="h-10 w-10 rounded-full object-cover shadow-sm" /><div><strong className="block text-sm">SK MailPilot</strong><span className="text-xs text-slate-500">Opening your workspace…</span></div></div></div>;
  }
